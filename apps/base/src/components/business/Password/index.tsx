...
import { Alert, Form, Input, Progress, Tooltip, Typography } from 'antd';
import { LModalFormProps } from 'lighting-design';
...
import { apiModifyPwd } from '@/pages/sys/user/service';
  ...
  return (
    <LModalForm
      ...
      onFinish={async (values) => {
        const { success } = await runModifyPwd({ ...values });
        return success;
      }}
      modalProps={{
        afterClose: () => {
